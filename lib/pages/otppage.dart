                              ...
                              if (int.parse(otpController.text) ==
                                ...
                                OneContext().showSnackBar(
                                    builder: (context) => ShowSnackBar()
                                        .customBar("Otp verified Successfully",
                                            context!, true));
                                Future.delayed(const Duration(seconds: 2), () {
                                  Navigator.of(context).pushReplacement(MaterialPageRoute(
                                      builder: (context) =>  HomePage(id: widget.id, userType: widget.userType,)));
                                });
                              } else {
                                OneContext().hideCurrentSnackBar();
                                OneContext().showSnackBar(
                                    builder: (context) => ShowSnackBar()
                                        .customBar("Please Enter correct Otp",
                                            context!));
                              }
                            },
                            style: ButtonStyle(
